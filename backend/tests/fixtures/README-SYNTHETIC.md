...
* Every pattern in `config/models/p2600n/*.yaml`,
  `config/models/p2800n/*.yaml` and `config/models/p2600l/*.yaml` is a
  **documented template** marked SYNTHETIC.
...
| `p2600l/` | Phase 6 (SYNTHETIC — **no real P2600L material received; nothing inferred from P2600N**, independent apl/jal/dgn sources): 1 successful (T-8801), 1 host-declined (T-8802), 1 failed+jam (T-8803) across apl+jal+dgn, incl. one malformed APL line (file PARTIAL) | |
